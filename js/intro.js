...
document.getElementById('column1').innerHTML="<h3>Holy Moly i changed the pg!</h3>";
document.getElementById('column1').innerHTML+="<p>wowowowowoowo! i can type</p>"
document.getElementById('column1').innerHTML+="<p>jfrsugbsjksfgsudfgbfjh</p>"
document.getElementById('column1').innerHTML+="<img class='img-fluid' src='images/code.jpg' alt='man olding note'>";
...
document.getElementById('col2').style.color="#80B6F9";
document.getElementById('col2').style.backgroundColor="#0E2549";
document.getElementById('col2').style.fontSize="24pt";
...
/* = replace.........> += add more*/
document.getElementById('c3').innerHTML += "<p>opponent health: "+health+"</p>";
...
document.getElementById('c3').innerHTML+="<p>"+weapon+" have this much damage: "+damage+"</p>";
